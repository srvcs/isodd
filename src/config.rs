...
pub struct Config {
    ...
    /// Base URL of the srvcs-iseven dependency.
...
impl Config {
    pub fn from_vars(
        ...
        Config {
            ...
            iseven_url: iseven_url.unwrap_or_else(|| "http://127.0.0.1:8082".to_string()),
        }
    }
    ...
    pub fn from_env() -> Self {
        Self::from_vars(
            ...
            std::env::var("SRVCS_ISEVEN_URL").ok(),
        )
    }
}
...
mod tests {
    ...
    fn defaults_are_sane() {
        ...
        assert_eq!(c.iseven_url, "http://127.0.0.1:8082");
    }
